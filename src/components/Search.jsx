    ...
    return (
        <>
            <form className='mb-8 flex items-center justify-center'>
                <input className='w-[300px] h-[50px] border border-sky-100 text-3xl text-center font-bold rounded-4xl focus:border focus:border-sky-200 text-gray-700' type="text" placeholder='Search city' onChange={(e) => setCity(e.target.value)}/>
